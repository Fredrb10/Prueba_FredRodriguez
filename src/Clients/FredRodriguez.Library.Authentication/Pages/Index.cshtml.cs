using FredRodriguez.Library.Authentication.Models;
...
namespace FredRodriguez.Library.Authentication.Pages
{
    public class IndexModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPost()
        {
            using (var client = new HttpClient())
            {
                ...
                return Redirect($"https://localhost:44360/libros/connect?access_token={result.AccessToken}");
            }
        }
    }
}
